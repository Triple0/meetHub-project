...
import { Feed, Icon, CommentAction } from 'semantic-ui-react'
...
export default class NewsFeed extends React.Component<ILayoutFormProps, IState> {
    ...
    render() {
        ...
        return (
            < Feed >
                {/* <Feed.Event> */}
                {/* <Feed.Label>
        <img src='/images/avatar/small/elliot.jpg' alt="elliot-avatar" />
      </Feed.Label>
      <Feed.Content>
        <Feed.Summary>
